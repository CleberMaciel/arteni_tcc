    ...
    function mostrar() {
        ...
        try {
           ...
           // $sql = $con->prepare("SELECT DISTINCT PRODUTO_CRIACAO.ID_PRODUTO_CRIACAO,PRODUTO_CRIACAO.NOME, PRODUTO_CRIACAO.LARGURA, PRODUTO_CRIACAO.ALTURA, PRODUTO_CRIACAO.PROFUNDIDADE, MATERIA_PRIMA.NOME, PRODUTO_CRIACAO.QTD_USADA, PRODUTO_CRIACAO.CODIGO from PRODUTO_CRIACAO JOIN MATERIA_PRIMA ON MATERIA_PRIMA.ID_MATERIA_PRIMA = PRODUTO_CRIACAO.MATERIA_PRIMA_ID_MATERIA_PRIMA");
            $sql = $con->prepare("SELECT ANY_VALUE(PRODUTO_CRIACAO.ID_PRODUTO_CRIACAO), ANY_VALUE(PRODUTO_CRIACAO.NOME), ANY_VALUE(PRODUTO_CRIACAO.LARGURA), ANY_VALUE(PRODUTO_CRIACAO.ALTURA), ANY_VALUE(PRODUTO_CRIACAO.PROFUNDIDADE), ANY_VALUE(MATERIA_PRIMA.NOME), ANY_VALUE(PRODUTO_CRIACAO.QTD_USADA), ANY_VALUE(PRODUTO_CRIACAO.CODIGO) from PRODUTO_CRIACAO JOIN MATERIA_PRIMA ON MATERIA_PRIMA.ID_MATERIA_PRIMA = PRODUTO_CRIACAO.MATERIA_PRIMA_ID_MATERIA_PRIMA GROUP BY PRODUTO_CRIACAO.NOME");
